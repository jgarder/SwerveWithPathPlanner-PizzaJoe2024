...
public class TunerConstants {
    ...
    private static final double kSlipCurrentA = 100;//Battle Creek Voltage = 30.0; Lansing = 44? Worlds = 60;

    // Theoretical free speed (m/s) at 12v applied output;
    // This needs to be tuned to your individual robot
    public static final double kSpeedAt12VoltsMps = 5.2;//4.3281; //4.572;//5.0;//6.0;//5.0;
    ...
    private static final double kSDSmk4iL3Plus = 5.36;
    //
    private static final double kDriveGearRatio = kSDSmk4iL3Plus;//kSDSmk4iL175;///8.14;//7.363636364;//brody changed from 6.75;
    private static final double kSteerGearRatio = 15.42857143;
    private static final double kWheelRadiusInches = 2.0;//known colsons -> 1.996;//1.9965;//1.992;//1.929;//2.167; // Estimated at first, then fudge-factored to make odom match record
