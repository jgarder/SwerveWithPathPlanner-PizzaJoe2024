...
public class AlignStageCMD extends Command {
  ...
  private void SetupTargetPosition() {
    ...
    {
      XP_Setpoint = Constants.TargetLocations.Blue.StageAMPSIDE_XP_Setpoint;
      YP_Setpoint = Constants.TargetLocations.Blue.StageAMPSIDE_YP_Setpoint;
      RZ_Setpoint = Constants.TargetLocations.Blue.StageAMPSIDE_RZ_Setpoint;
