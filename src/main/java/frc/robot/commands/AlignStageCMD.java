...
public class AlignStageCMD extends Command {
  ...
  { 
    ...
    // var distancetotarget = Constants.getdistancetopose(CurrentPose,PoseToCheck);  
    // if (distancetotarget < closesttagdistance) 
    // {
    //   closesttagdistance = distancetotarget;
    //   TargetPose = PoseToCheck;
    // } 
    // PoseToCheck  = Constants.TargetLocations.Red.TrapFloorStageSourceSide;
    // distancetotarget = Constants.getdistancetopose(CurrentPose,PoseToCheck);
    // if (distancetotarget < closesttagdistance) 
    // {
    //   TargetPose = PoseToCheck;
    // } 
    // PoseToCheck  = Constants.TargetLocations.Red.TrapFloorStageCenterSide;
    // distancetotarget = Constants.getdistancetopose(CurrentPose,PoseToCheck);
    // if (distancetotarget < closesttagdistance) 
    // {
    //   TargetPose = PoseToCheck;
    ...
    {
      TargetPose = Constants.TargetLocations.Red.ClimbChainStageAmpSIDE;
    } 
    else if (targetID == Constants.AllianceAprilTags.Red.StageSourceSide) 
    {
      TargetPose = Constants.TargetLocations.Red.ClimbChainStageSourceSIDE;
    } 
    else if (targetID == Constants.AllianceAprilTags.Red.StageCenterSide) 
    {
      TargetPose = Constants.TargetLocations.Red.ClimbChainStageCenterSIDE;
    }
    else end(true);
  ...
  {
    // Pose2d PoseToCheck  = Constants.TargetLocations.Blue.ClimbChainStageAmpSIDE;
    // var distancetotarget = Constants.getdistancetopose(CurrentPose,PoseToCheck); 
    // if (distancetotarget < closesttagdistance) 
    // {
    //   closesttagdistance = distancetotarget;
    //   TargetPose = PoseToCheck;
    // } 
    // PoseToCheck  = Constants.TargetLocations.Blue.ClimbChainStageSourceSIDE;
    // distancetotarget = Constants.getdistancetopose(CurrentPose,PoseToCheck);
    // if (distancetotarget < closesttagdistance) 
    // {
    //   TargetPose = PoseToCheck;
    // } 
    // PoseToCheck  = Constants.TargetLocations.Blue.ClimbChainStageCenterSIDE;
    // distancetotarget = Constants.getdistancetopose(CurrentPose,PoseToCheck);
    // if (distancetotarget < closesttagdistance) 
    // {
    //   TargetPose = PoseToCheck;
    ...
    {
      TargetPose = Constants.TargetLocations.Blue.ClimbChainStageAmpSIDE;
    } 
    else if (targetID == Constants.AllianceAprilTags.Blue.StageSourceSide) 
    {
      TargetPose = Constants.TargetLocations.Blue.ClimbChainStageSourceSIDE;
    } 
    else if (targetID == Constants.AllianceAprilTags.Blue.StageCenterSide) 
    {
      TargetPose = Constants.TargetLocations.Blue.ClimbChainStageCenterSIDE;
    } 
    else end(true);
  ...
  public AlignStageCMD(DrivetrainManager Thiss_Swerve,DoubleSupplier strafeSup) {
