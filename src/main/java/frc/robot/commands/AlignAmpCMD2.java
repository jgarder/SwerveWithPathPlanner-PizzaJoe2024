...
public class AlignAmpCMD2 extends Command {
  ...
  public AlignAmpCMD2(DrivetrainManager Thiss_Swerve, DoubleSupplier strafeSup) {
...
private void SetPidControlersToRed_Amp() {
  XP_Setpoint = 14.74;
  YP_Setpoint = 7.56;
  RZ_Setpoint = 90;
...
private void SetPidControlersToBlue_Amp() {
